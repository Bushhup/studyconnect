  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Button onClick={() => toast({ title: 'Request Sent', description: 'Institutional data updates require admin approval.' })} variant="outline" className="rounded-full gap-2 border-slate-200">
            ...
            <CardHeader className="text-center pb-8 border-b border-slate-50">
              <div className="relative mx-auto w-fit">
                <Avatar className="h-32 w-32 border-4 border-white shadow-2xl ring-1 ring-slate-100">
                  ...
                  <AvatarFallback className="text-3xl font-bold bg-primary/5 text-primary">AJ</AvatarFallback>
                </Avatar>
              ...
              <CardTitle className="text-2xl font-headline font-bold mt-4">Alex Johnson</CardTitle>
              <p className="text-sm font-bold text-primary uppercase tracking-widest mt-1">@alex_johnson_2024</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-none shadow-sm bg-white rounded-[2.5rem] overflow-hidden">
            ...
            <CardContent className="pt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                { label: 'Student ID', value: '2024CS01', icon: User },
                { label: 'Department', value: 'Engineering & Technology', icon: Building2 },
