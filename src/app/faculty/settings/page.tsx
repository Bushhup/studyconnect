                 ...
                 <div className="flex flex-col md:flex-row items-center gap-8">
                    <div className="relative">
                       <Avatar className="h-24 w-24 border-4 border-white shadow-xl ring-1 ring-slate-100">
                          ...
                          <AvatarFallback className="text-2xl font-bold bg-primary/5 text-primary">SS</AvatarFallback>
                       </Avatar>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 w-full">
                       <div className="space-y-2">
                          ...
                          <Input defaultValue="Dr. Sarah Smith" className="bg-slate-50 border-none h-11 rounded-xl" />
                       </div>
                       <div className="space-y-2">
                          <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Email Address</Label>
                          <Input defaultValue="sarah.smith@college.edu" readOnly className="bg-slate-50 border-none h-11 rounded-xl text-muted-foreground" />
                       </div>
                       <div className="space-y-2">
                          <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Department</Label>
                          <Input defaultValue="Engineering & Technology" readOnly className="bg-slate-50 border-none h-11 rounded-xl text-muted-foreground" />
                       </div>
                       <div className="space-y-2">
                          <Label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Staff ID</Label>
                          <Input defaultValue="F-2024-882" readOnly className="bg-slate-50 border-none h-11 rounded-xl text-muted-foreground" />
                       </div>
                    </div>
                 </div>
              </CardContent>
