    ...
    <div className="space-y-8 pb-12">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'roster' && (
            <motion.div key="tab-roster" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
          ...
          {activeTab === 'timetable' && (
            <motion.div key="tab-timetable" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
              <Card className="border-none shadow-sm bg-card rounded-[2rem] overflow-hidden">
          ...
          {activeTab === 'handlers' && (
            <motion.div key="tab-handlers" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
